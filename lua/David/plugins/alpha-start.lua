return {
    ...
    config = function()
        ...
        dashboard.section.buttons.val = {
            ...
            dashboard.button("G", "   Go Projects", ":cd /Programming/Go | :Ex<CR>"),
            dashboard.button("J", "   JavaScript Projects", ":cd /Programming/Web | :Ex<CR>"),
            dashboard.button("L", "   Lua Projects", ":cd /Programming/Lua | :Ex<CR>"),
            dashboard.button("g", "󰱼   Find word", ":Telescope live_grep<CR>"),
            dashboard.button("r", "   Recent", ":Telescope oldfiles<CR>"),
            dashboard.button("c", "   Config", ":cd " .. localAppData .. "| :Ex<CR>"),
            dashboard.button("m", "󱌣   Mason", ":Mason<CR>"),
            dashboard.button("l", "󰒲   Lazy", ":Lazy<CR>"),
            dashboard.button("u", "󰂖   Update plugins", "<cmd>lua require('lazy').sync()<CR>"),
            dashboard.button("q", "󱡞   Quit NVIM", ":qa<CR>"),
        }
